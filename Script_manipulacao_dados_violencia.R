...
dados_violencia_geral <- read.dbf("C:/Users/x14339682/Desktop/Dados atualização/dados_violencia_geral.dbf")

class(dados_violencia_geral$DT_NOTIFIC)
class(dados_violencia_geral$DT_NASC)

dados_violencia_geral2 <- dados_violencia_geral %>%
...
write.xlsx(dados_violencia_geral,"teste_violencia.xlsx")
write.xlsx(dados_violencia_geral2,"teste_violencia2.xlsx")